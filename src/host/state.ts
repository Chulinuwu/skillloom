...
export function hostPaths(hostRoot: string) {
  return {
    ...
    obsidianVaultShell: join(hostRoot, "obsidian-config", "vault-shell"),
    ...
    obsidianProjectionLibrary: join(hostRoot, "data", "brain", "projections", "obsidian-vault", "Library"),
    obsidianLibraryMountpoint: join(hostRoot, "obsidian-config", "vault-shell", "Library"),
    obsidianVaultConfigMountpoint: join(hostRoot, "obsidian-config", "vault-shell", ".obsidian"),
    obsidianBasesMountpoint: join(hostRoot, "obsidian-config", "vault-shell", "Bases"),
    obsidianAuthoringMountpoint: join(hostRoot, "obsidian-config", "vault-shell", "Authoring"),
